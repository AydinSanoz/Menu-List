...
const sectionCenterElement = document.querySelector('.section-center');
const buttonContainerElement = document.querySelector('.btn-container');
// console.log("buttonContainerElement", buttonContainerElement)
...
function displayMenuItems(menuList){
    ...
    sectionCenterElement.innerHTML = sectionCenter;
...
function displayCategoryItems(){
    let categories = [];
    let categoryContent = "";
    categoryContent = `<button type="button" class="filter-btn" data-id="all">all</button>`;
    ...
    buttonContainerElement.innerHTML = categoryContent
    ...
    filterButtonElements.forEach((button) => {
        button.addEventListener('click',function(e){
            ...
            console.log("displayCategoryItems -> filteredMenu", filteredMenu)
